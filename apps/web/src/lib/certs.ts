...
export const certOptions: CertOption[] = [
  ...
  { code: "saa", name: "AWS Certified Solutions Architect - Associate (SAA-C03)" },
  { code: "dva", name: "AWS Certified Developer - Associate (DVA-C02)" },
  { code: "soa", name: "AWS Certified CloudOps Engineer - Associate (SOA-C03)" },
  { code: "dea", name: "AWS Certified Data Engineer - Associate (DEA-C01)" },
  { code: "mla", name: "AWS Certified Machine Learning Engineer - Associate (MLA-C01)" },
  { code: "sap", name: "AWS Certified Solutions Architect - Professional (SAP-C02)" },
  { code: "dop", name: "AWS Certified DevOps Engineer - Professional (DOP-C02)" },
  { code: "aip", name: "AWS Certified Generative AI Developer - Professional (AIP-C01)" },
  { code: "ans", name: "AWS Certified Advanced Networking - Specialty (ANS-C01)" },
...
export const aipDomains: DomainOption[] = [
  ...
  { value: "d1", label: "基盤モデル統合・データ管理・コンプライアンス", weight: 31 },
